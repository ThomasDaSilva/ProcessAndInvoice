...
class ProcessAndInvoiceController extends BaseAdminController
{
    ...
    protected function returnHTMLInvoice($orderID, $fileName, TemplateHelperInterface $templateHelper): RedirectResponse|Response
    {
    ...
    protected function returnHTMLReport($fileName, $totalTurnover, $totalOrders, TemplateHelperInterface $templateHelper): RedirectResponse|Response
    {
        return $this->renderRaw(
            $fileName,
            array(
